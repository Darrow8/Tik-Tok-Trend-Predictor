...
var tiktok_api_1 = __importStar(require("tiktok-api"));
...
var signURL = function (url, ts, deviceId) { return __awaiter(void 0, void 0, void 0, function () {
    var as, cp, mas;
    return __generator(this, function (_a) {
        as = 'anti-spam parameter 1';
        cp = 'anti-spam parameter 2';
        mas = 'anti-spam parameter 3';
        return [2 /*return*/, url + "&as=" + as + "&cp=" + cp + "&mas=" + mas];
    });
}); };
...
var params = tiktok_api_1.getRequestParams({
    device_id: '<device_id>',
    fp: '<device_fingerprint>',
    iid: '<install_id>',
    openudid: '<device_open_udid>',
});
var api = new tiktok_api_1.default(params, { signURL: signURL });
